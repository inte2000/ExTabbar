...
//	config.configure();
	log4cplus::tstring fileName = GetLocalAppDataPath() + _T("\\Extabbar.log");
    ...
    LOG4CPLUS_TRACE(m_logger, _T("Extabbar Shell Extension object starting!"));
...
{
    LOG4CPLUS_TRACE(m_logger, _T("Extabbar Shell Extension object stoped!\n\n"));
