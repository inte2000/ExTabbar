...
class CTeTabctrlImpl :
  public CDotNetTabCtrlImpl<T, TItem, TBase, TWinTraits>
{
protected:
  typedef CTeTabctrlImpl<T, TItem, TBase, TWinTraits> thisClass;
...
public:
  ...
  // Message Handling
public:
  DECLARE_WND_CLASS_EX(_T("WTL_CTeTabctrl"), CS_DBLCLKS, COLOR_WINDOW)
...
class CTeTabctrl :
  public CTeTabctrlImpl<CTeTabctrl<TItem>, TItem>
{
protected:
  typedef CTeTabctrl<TItem> thisClass;
  typedef CTeTabctrlImpl<CAeroTabCtrl<TItem>, TItem> baseClass;
